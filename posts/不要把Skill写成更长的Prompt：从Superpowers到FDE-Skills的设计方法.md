---
publish: true
slug: skill-design-superpowers-fde-skills
title: 不要把 Skill 写成更长的 Prompt：从 Superpowers 到 FDE Skills 的设计方法
summary: Skill 不应该只是更长的 Prompt，而应该围绕工作阶段和失败模式设计成可组合、可维护的行为约束。
category: Skill设计
tags: [Skill, Superpowers, FDE]
